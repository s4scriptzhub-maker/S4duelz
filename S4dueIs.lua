...
-- OWNER TAG
do
    local Owners = { ["S4duelsmaker"] = true, ["S4int"] = true }
    local tagged = {}
...
local ToggleIcon = create("TextButton", {
    ...
    BackgroundColor3 = COLORS.MainBG, Text = "S4", TextColor3 = COLORS.Border,
...
LockButton.MouseButton1Click:Connect(function()
    ...
    LockButton.Text = isGuiLocked and "🔒" or "🔓"
end)
...
local function createSpeedUI()
    ...
    create("TextLabel", {
        ...
        BackgroundTransparency = 1, Text = "S4duels Speed Customizer",
    ...
    -- =====================================================================
    -- MOBILE-FRIENDLY DRAG (works on iPad, iPhone, PC) - NOW RESPECTS GUI LOCK
    -- =====================================================================
    ...
    local function onSpeedDragChanged(input)
        if isGuiLocked or not dragSpeed then return end
...
do
    local ok, data = pcall(readfile, "S4duelsSpeed.txt")
...
-- UPDATED: attachOvalDrag NOW RESPECTS GUI LOCK
local function attachOvalDrag(btn)
    ...
    btn.InputChanged:Connect(function(input)
        if isGuiLocked or not dragging then return end
...
local function agCreateGui()
    ...
    makeLabel("S4duels Grab", 10, 100, Color3.fromRGB(255, 255, 255))
    makeDivider(114)
...
-- UPDATED: DecentBtn drag NOW RESPECTS GUI LOCK
...
-- UPDATED: main drag function NOW RESPECTS GUI LOCK
local function drag(f)
    ...
    UserInputService.InputChanged:Connect(function(i)
        if isGuiLocked or not d then return end
