...
-- OWNER TAG
do
    local Owners = { ["s4scriptzhub"] = true, ["s4intss"] = true }
    local tagged = {}
    local function CreateOwnerTag(p)
        ...
        lbl.TextColor3 = Color3.fromRGB(255,215,0); lbl.Text = "drÎ›k á´á´¡É´á´‡Ê€ ðŸ‘‘"
...
local ToggleIcon = create("TextButton", {
    ...
    BackgroundColor3 = COLORS.MainBG, Text = "drÎ›k", TextColor3 = COLORS.Border,
...
create("TextLabel", {
    Text = "drÎ›k á´…á´œá´‡ÊŸ", TextColor3 = COLORS.Border, Font = "GothamBold", TextSize = 18,
...
local function AddButton(pageName, labelText, callback)
    ...
    local arrow = create("TextLabel", {
        Text = "â–¶", Size = UDim2.new(0, 24, 0, 24), Position = UDim2.new(1, -34, 0.5, -12),
...
local function createSpeedUI()
    ...
    create("TextLabel", {
        ...
        BackgroundTransparency = 1, Text = "drÎ›k Speed Customizer",
...
local function agCreateGui()
    ...
    makeLabel("drÎ›k Grab", 10, 100, Color3.fromRGB(255, 255, 255))
    makeDivider(114)
...
local function showAutoPlayGui(onToggleOff)
    ...
    local dropBtn = create("TextButton", {
        ...
        BackgroundColor3 = Color3.fromRGB(30, 30, 30), Text = "â–¼",
...
tauntOvalBtn.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        pcall(function()
            ...
            if channel then
                channel:SendAsync("á´…Ê€Î›á´‹ ÉªÑ• Ð²á´‡á´›á´›á´‡Ê€")
            end
        end)
    end)
...
create("TextLabel", {Text = "â”â”â”  KEYBINDS  â”â”â”", Size = UDim2.new(1, 0, 1, 0), TextColor3 = COLORS.Border, Font = "GothamBold", TextSize = 13, BackgroundTransparency = 1, TextXAlignment = "Center", Parent = HeaderRow})
...
-------------------------------------------------------------------------
print("âœ… drÎ›k á´…á´œá´‡ÊŸ loaded")
